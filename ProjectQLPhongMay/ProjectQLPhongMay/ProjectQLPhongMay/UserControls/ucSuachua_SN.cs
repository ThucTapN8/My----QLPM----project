...
{
    public partial class ucSuachua_SN : UserControl
    {
        private SqlConnection strconnect;
        public ucSuachua_SN(SqlConnection strconnect)
        {
            InitializeComponent();
            this.strconnect = strconnect;
        }

        private void ucSuachua_SN_Load(object sender, EventArgs e)
        {
            SqlCommand command = new SqlCommand("SP_THONGKESUACHUA_SUATREN5", strconnect);
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                excel.ActiveWorkbook.SaveCopyAs("D:\\Danhsachsuanhieulan.xlsx");
