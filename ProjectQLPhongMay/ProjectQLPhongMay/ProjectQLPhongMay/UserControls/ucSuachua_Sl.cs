...
{
    public partial class ucSuachua_Sl : UserControl
    {
        private SqlConnection strconnect;
        public ucSuachua_Sl(SqlConnection strconnect)
        {
            InitializeComponent();
            this.strconnect = strconnect;
        }

        private void ucSuachua_Sl_Load(object sender, EventArgs e)
        {
            SqlCommand command = new SqlCommand("SP_THONGKE_DSSUACHUATHIETBI", strconnect);
            ...
            gridCSuachuaSl.DataSource = dt_thongke;
        }
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                excel.ActiveWorkbook.SaveCopyAs("D:\\Danhsachsolansuachua.xlsx");
