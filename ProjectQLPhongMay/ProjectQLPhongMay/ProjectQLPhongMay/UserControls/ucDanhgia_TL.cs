...
{
    public partial class ucDanhgia_TL : UserControl
    {
        private SqlConnection strconnect;
        public ucDanhgia_TL(SqlConnection strconnect)
        {
            InitializeComponent();
        ...
        private void ucDanhgia_TL_Load(object sender, EventArgs e)
        {
            SqlCommand command = new SqlCommand("SP_THONGKE_DGTB_TL", strconnect);
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                excel.ActiveWorkbook.SaveCopyAs("D:\\Danhsachthiếtbithanhly.xlsx");
