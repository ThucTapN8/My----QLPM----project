...
{
    public partial class ucTTB_Ct : UserControl
    {
        private SqlConnection strconnect;
        public ucTTB_Ct(SqlConnection strconnect)
        {
            InitializeComponent();
        ...
        {
            SqlCommand command = new SqlCommand("SP_THONGKE_DSTTB", strconnect);
            ...
            gridCTTB_Ct.DataSource = dt_thongke;
        }
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                excel.ActiveWorkbook.SaveCopyAs("D:\\DanhsachchitietTTB.xlsx");
